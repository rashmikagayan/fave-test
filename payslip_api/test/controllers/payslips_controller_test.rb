...
class PayslipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should fail when provided non numarical or negative value" do
    post '/payslip/generate', params: {
      employee_name: "Ren",
      annual_salary: -1
    }, as: :json
  ...
  test "should generate and store monthly payslip" do
